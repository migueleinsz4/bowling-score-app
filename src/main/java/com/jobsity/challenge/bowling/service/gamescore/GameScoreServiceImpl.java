...
public class GameScoreServiceImpl implements GameScoreService {
    ...
    @Override
    public GameResult parseGameResultFile(String source, boolean fromClasspath) {
        List<String> result = this.sourceReaderService.readSource(source, fromClasspath);
        return this.scoringEngineService.validateResultData(source, result);
    }
